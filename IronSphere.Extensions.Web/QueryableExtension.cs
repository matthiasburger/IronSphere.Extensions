...
{
    /// <summary>
    /// This class provides extension methods for <see cref="IQueryable{T}"/>
    /// </summary>
    public static class QueryableExtension
    {
        ...
        /// <param name="this">the actual enumerable source</param>
        ...
        public static IQueryable<T> LexTake<T>([NotNull]this IQueryable<T> @this, int? count)
        {
            if (@this == null)
                throw new ArgumentNullException(nameof(@this));

            return !count.HasValue ? @this : @this.Take(count.Value);
        }
        ...
        /// <param name="count">the number of elements to take (or null if take all)</param>
        /// <returns>A specified number of contiguous elements elements from the start of a sequence.</returns>
        public static IQueryable<T> LexTakeLast<T>([NotNull]this IQueryable<T> @this, int count)
        {
            if (@this == null)
                throw new ArgumentNullException(nameof(@this));
        ...
        /// <returns>A specified number of contiguous elements elements from the start of a sequence.</returns>
        public static IQueryable<TSource> LexSkip<TSource>([NotNull]this IQueryable<TSource> source, int? count)
        {
            if (source == null)
        ...
        /// <param name="count">the number of elements to skip (or null if skip all)</param>
        /// <returns>A specified number of contiguous elements elements from the start of a sequence.</returns>
        public static IQueryable<TSource> LexSkipLast<TSource>([NotNull]this IQueryable<TSource> @this, int count)
        {
            if (@this == null)
                throw new ArgumentNullException(nameof(@this));
        ...
        public static IQueryable<IJoinSet<TSource, TJoin>> LexLeftJoin<TSource, TJoin, TKey>(
            [NotNull]this IQueryable<TSource> source,
            [NotNull]IQueryable<TJoin> inner,
            [NotNull]Expression<Func<TSource, TKey>> outerKeySelector,
            [NotNull]Expression<Func<TJoin, TKey>> innerKeySelector)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (inner == null)
        ...
        public static IQueryable<IJoinSet<TJoin, TSource>> LexRightJoin<TSource, TJoin, TKey>(
            [NotNull]this IQueryable<TSource> source,
            [NotNull]IQueryable<TJoin> inner,
            [NotNull]Expression<Func<TSource, TKey>> outerKeySelector,
            [NotNull]Expression<Func<TJoin, TKey>> innerKeySelector)
        ...
        public static IQueryable<TSource> LexDistinctBy<TSource, TKey>([NotNull]this IQueryable<TSource> source, [NotNull]Expression<Func<TSource, TKey>> groupingSelector)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
