...
namespace IronSphere.Extensions
{
    ...
    {
        public static bool? ToBool(this string @this) => bool.TryParse(@this, out bool temp) ? temp : null;
        ...
        public static decimal? ToDecimal(this string @this, NumberStyles numberStyles, IFormatProvider formatProvider) => decimal.TryParse(@this, numberStyles, formatProvider, out decimal temp) ? temp : null;
        public static double? ToDouble(this string @this) => double.TryParse(@this, out double temp) ? temp : null;
        public static double? ToDouble(this string @this, NumberStyles numberStyles, IFormatProvider formatProvider) => double.TryParse(@this, numberStyles, formatProvider, out double temp) ? temp : null;
